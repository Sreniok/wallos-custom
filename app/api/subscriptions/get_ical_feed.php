...
if ($_SERVER["REQUEST_METHOD"] === "POST" || $_SERVER["REQUEST_METHOD"] === "GET") {
    ...
    foreach ($subscriptions as $subscription) {
        ...
        $upcomingPayment = getUpcomingSubscriptionPaymentDate($subscription) ?? $subscription['next_payment'];
        ...
        $dtstart = (new DateTime($upcomingPayment))->format('Ymd');
        $dtend = (new DateTime($upcomingPayment))->format('Ymd');
