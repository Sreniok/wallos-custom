...
$i18n = [
    ...
    "no_paid_this_month" => "Nie masz jeszcze żadnych płatności zaksięgowanych w tym miesiącu",
    "paid_this_cycle" => "Opłacone w tym cyklu",
    "no_paid_this_cycle" => "Nie masz jeszcze żadnych płatności zaksięgowanych w bieżącym cyklu wypłat",
    ...
    "petrol" => "Paliwo",
    "diesel" => "Diesel",
    "petrol_this_month" => "Paliwo w tym miesiącu",
    "petrol_this_cycle" => "Paliwo w tym cyklu",
    "petrol_last_month" => "Paliwo w poprzednim miesiącu",
    "petrol_last_cycle" => "Paliwo w poprzednim cyklu",
    "last_payroll_month" => "Poprzedni miesiąc rozliczeniowy",
    "last_calendar_month" => "Poprzedni miesiąc kalendarzowy",
    "petrol_average_monthly" => "Średnie paliwo / miesiąc",
    "petrol_yearly_total" => "Paliwo w tym roku",
    "petrol_yearly_cost" => "Roczny koszt paliwa",
    "petrol_last_fill" => "Ostatnie tankowanie",
    "petrol_history" => "Historia tankowań",
    "petrol_vehicles" => "Pojazdy",
    "new_petrol_vehicle" => "Nowy pojazd",
    "vehicle_registration" => "Numer rejestracyjny",
    "fills" => "tankowań",
    "fill" => "tankowanie",
    "enable_digest_mode" => "Włącz dzienne podsumowanie",
    "digest_mode_hint" => "Zastępuje przypomnienia dla pojedynczych subskrypcji jednym dziennym e-mailem z listą wszystkich płatności w najbliższych N dniach.",
    "digest_horizon_days_label" => "Liczba dni do przodu",
    "payroll_month" => "Miesiąc rozliczeniowy",
    "calendar_month" => "Miesiąc kalendarzowy",
    // Subscriptions page
    ...
    "relative_today" => "dzisiaj",
    "relative_tomorrow" => "jutro",
    "relative_in_n_days" => "za %d dni",
    "relative_1_day_late" => "1 dzień po terminie",
    "relative_n_days_late" => "%d dni po terminie",
    "clone" => "Klonuj",
    "renew" => "Odnów",
    ...
    "cycle" => "Cykl",
    "regular_price" => "Kolejne płatności",
    "regular_price_placeholder" => "Opcjonalna kwota po pierwszej płatności",
    "regular_price_help" => "Zostaw puste, jeśli każda płatność ma mieć tę samą kwotę.",
    "regular_price_must_be_positive" => "Kwota kolejnych płatności musi być większa od 0.",
    ...
    "last_payment_date" => "Data ostatniego pobrania",
    "last_payment_date_help" => "Opcjonalnie. Po pobraniu tej ostatniej płatności subskrypcja zostanie wyłączona i dostaniesz powiadomienie o zakończeniu.",
    "last_payment_date_after_next_payment" => "Data ostatniego pobrania musi być taka sama jak następna płatność albo późniejsza.",
    "delete" => "Usuń",
    "cancel" => "Anuluj",
    ...
    "no_stats_for_filters" => "Brak statystyk pasujących do wybranych filtrów.",
    ...
    "enable_second_notification" => "Włącz drugie powiadomienie",
    ...
    // Calendar
    "calendar" => "Kalendarz",
    "calendar_feed" => "Feed kalendarza",
    "enable_calendar_feed" => "Włącz feed kalendarza",
    "subscribe_in_calendar" => "Subskrybuj w kalendarzu",
    "ical_feed_info" => "Użyj tego prywatnego adresu webcal w Google Calendar, Apple Calendar, Outlooku albo innej aplikacji obsługującej subskrypcje iCalendar. Ponowne wygenerowanie tokenu wyłącza poprzedni adres URL.",
    "ical_token_regenerated" => "Adres feedu kalendarza został wygenerowany ponownie",
    "copied_to_clipboard" => "Skopiowano do schowka",
    "previous_month" => "Poprzedni miesiąc",
    "next_month" => "Następny miesiąc",
    "open_subscription" => "Otwórz subskrypcję",
    "no_payments_this_month" => "W tym miesiącu nie ma żadnych płatności.",
    "sun" => "Niedz.",
    "mon" => "Pon.",
    "tue" => "Wt.",
    "wed" => "Śr.",
